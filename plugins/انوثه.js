let handler = async (m, { conn, command, text, usedPrefix, participants }) => {
    if (!text) throw "*مـنـشـن الــشـخص الـذي تـريـد مـعـرفة نـسـبـة انثويته !*"
 ...
 "100%",
    ...
    let message = `*@${mentionedUser.split("@")[0]} انــه انثوي بـنـسـبــة ${userCharacterSeletion}*`
