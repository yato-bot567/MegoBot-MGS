...
let handler = async (m, { conn, text, usedPrefix, command, args, participants, isOwner }) => {
  ...
  m.reply(`👆🏿 انتظر 3 ثواني, سأنضم الى المجموعه يكبير`)
  await delay(3000)
  try {
 ...
 if (e.length) await conn.reply(res, `السلام عليكم يرجاله
...
لقد تم دعوتي بواسطة *${m.name}*`, m, {
    mentions: d
     ...
     await conn.reply(res, `السلام عليكم ورحمة الله وبركاتة`, 0)
